...
settings = {
    ...
    'chat-instruct_command': 'Continue the chat dialogue below. Write a single very short reply for the character "<|character|>".\n\n<|prompt|>',
...
# ElevenLabs
group.add_argument('--elevenlabs_api_key', type=str, default='', help='API key for the Eleven Labs API.')
